...
public:
	...
	void SetIconAuto(LPWSTR strPath, LPWSTR strIcon, UINT nIconAlign=BS_CENTER, LPWSTR strIconDown=0, LPWSTR strIconHighLight=0);
	void SetIcon(LPWSTR strIcon, UINT nIconAlign=BS_CENTER, LPWSTR strIconDown=0, LPWSTR strIconHighLight=0, int cx=0, int cy=0);
	void SetIcon(UINT nIcon, UINT nIconAlign=BS_CENTER, UINT nIconDown=0, UINT nIconHighLight=0, int cx=0, int cy=0);
	void SetShade(UINT shadeID=0,BYTE granularity=8,BYTE highlight=10,BYTE coloring=0,COLORREF color=0);
	void SetToolTipText(CString s, CString sDown=L"");
