	...
	if (fullver==0)
	{
		...
		*/
		...
		if (fullver == 0)
		{
			...
			if (VerifyVersionInfoW(&osvi, dwTypeMask, dwlConditionMask)) fullver = 0x602;
		}
		if (fullver == 0)
		{
			osvi.dwMajorVersion = 6; osvi.dwMinorVersion = 0;
			if (VerifyVersionInfoW(&osvi, dwTypeMask, dwlConditionMask)) fullver = 0x600;
		}
		if (fullver == 0)
		{
			osvi.dwMajorVersion = 5; osvi.dwMinorVersion = 1;
			if (VerifyVersionInfoW(&osvi, dwTypeMask, dwlConditionMask)) fullver = 0x501;
		}
		if (fullver == 0) fullver = 0x500;
	}
...
{
	if(m_cb_Grid.GetParam(G_CbMsg_CellColor, nRow, nCol, (void*)&textColor, (void*)&backColor))
		return true;
	return false;
}
...
{
	if(m_cb_Grid.GetParam(G_CbMsg_CellFont, nRow, nCol, (void*)&font))
		return true;
	return false;
}
...
{
	if(m_cb_Grid.GetParam(G_CbMsg_RowColor, nRow, (void*)&textColor, (void*)&backColor))
		return true;
	return false;
}
...
{
	if(m_cb_Grid.GetParam(G_CbMsg_RowFont, nRow, (void*)&font))
		return true;
	return false;
}
