...
typedef bool (*bool_cb_grid)(void* Ptr, int* n_val, void* p_val[2]);
struct cbg_struct
{
	void* m_ptr;
	bool_cb_grid _cb_func;
	...
	cbg_struct(void* ptr, bool_cb_grid func)
	{
		m_ptr = ptr;
		_cb_func = func;
	}
	inline bool GetParam(int nMsg, int nRow, void* Param1, void* Param2 = NULL)
	{
		if(_cb_func)
		{
			int   n_val[2] = {nMsg, nRow};
			void* p_val[2] = {Param1, Param2};
			return _cb_func(m_ptr, n_val, p_val);
		}
		return false;
	}
	inline bool GetParam(int nMsg, int nRow, int nCol, void* Param1, void* Param2 = NULL)
	{
		if(_cb_func)
		{
			int   n_val[3] = {nMsg, nRow, nCol};
			void* p_val[2] = {Param1, Param2};
			return _cb_func(m_ptr, n_val, p_val);
		}
		return false;
...
{
public:
	cbg_struct m_cb_Grid;
	void SetCallback(cbg_struct* pCb){m_cb_Grid = *pCb;}
